...
func Plugin(ctx context.Context) *plugin.Plugin {
	p := &plugin.Plugin{
		...
		TableMap: map[string]*plugin.Table{
			...
			// "chaos_list_panic":                   buildTable(&chaosTable{name: "chaos_list_panic", description: "Chaos table to test panicking List function", listConfig: &listConfig{listError: FailPanic}}),
			// "chaos_list_delay":                   buildTable(&chaosTable{name: "chaos_list_delay", description: "Chaos table to test delay in List function", listConfig: &listConfig{listDelay: true}}),
