...
func Plugin(ctx context.Context) *plugin.Plugin {
	p := &plugin.Plugin{
		...
		TableMap: map[string]*plugin.Table{
			...
			"chaos_get_key_column_single_equal":            getKeyColumnsSingleEqualsTable(),  // test the Hydrate call with all the possible scenarios like errors, panics and delays
			"chaos_get_key_columns_any_multiple_operator":  getKeyColumnsAnyMultipleOperatorTable(),  // test the Hydrate call with all the possible scenarios like errors, panics and delays
			"chaos_get_key_columns_all_multiple_operator":  getKeyColumnsAllMultipleOperatorTable(),         // test the Hydrate call with all the possible scenarios like errors, panics and delays
		},
