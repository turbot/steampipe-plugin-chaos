...
func Plugin(context.Context) *plugin.Plugin {
	p := &plugin.Plugin{
		...
		TableMap: map[string]*plugin.Table{
			...
			"chaos_list_error":                 buildTable(&chaosTable{name: "chaos_list_error", description: "Chaos table to test error handling in List function", listError: FailError}),
			...
			"chaos_hydrate_error":              buildTable(&chaosTable{name: "chaos_hydrate_error", description: "Chaos table to test error handling in Hydrate function", hydrateError: FailError}),
