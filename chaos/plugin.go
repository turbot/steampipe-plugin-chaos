...
func Plugin(ctx context.Context) *plugin.Plugin {
	p := &plugin.Plugin{
		...
		TableMap: map[string]*plugin.Table{
			...
			"chaos_list_parent_child_column_errors":                        chaosListParentChildColumnErrorsTable(),                // test the List calls having parent-child dependencies with all the possible scenarios like errors, panics and delays at both parent and child levels
